...
import javafish.clients.opc.property.*;
...
abstract public class JCustomOpc {
 ...
 /* static {
		...
		PropertyLoader prp = new PropertyLoader ();
	  prp.loadProperties("iocl.properties");
	  String val = prp.getValue("DDLPath");
	  
	  System.out.println(" java library path=" +System.getProperty("java.library.path"));
	  System.setProperty("java.library.path", val);
	  System.out.println(" After updating java library path=" +System.getProperty("java.library.path"));
...
//	  String val = prp.getValue("DDLPath");
  ...
  // props = PropertyLoader.loadProperties(JCustomOpc.class);
   //props=PropertyLoader.loadProperties("iocl.properties");

	  // load native library OPC Client
    
 //  System.setProperty("library.path","JCustomOpc.dll");
  // System.loadLibrary(props.getProperty("library.path"));
//	  if (null != val)
//	  
	  //{
...
static {
	System.out.println("Loading libarty JCustomOpc dll.....");
  // load class properties
 /* props = PropertyLoader.loadProperties(JCustomOpc.class);
  //System.out.println("props:"+props);
  // load native library OPC Client
  System.loadLibrary(props.getProperty("library.path"));*/
	//System.setProperty("java.library.path", "D:/IOCLFINALCODE/IOCLAutomation/lib/JCustomOpc.dll");
    System.out.println(System.getProperty("java.library.path"));
     System.loadLibrary("./lib/JCustomOpc");
  // System.loadLibrary("D:/IOCLFINALCODE/IOCLAutomation/lib/JCustomOpc.dll");
	System.out.println("Loading libarty JCustomOpc completed.....");
